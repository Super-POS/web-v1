...
// -----------------------------------------------------------------------------------------------------
// @ HELPER TailwindCSS Main Plugin
// -----------------------------------------------------------------------------------------------------
            ...
            const schemeCustomProps = _.map(
                ...
                (colorScheme) => {
                    ...
                    const background = theme(
                        `helper.customProps.background.${colorScheme}`
                    );
                    const foreground = theme(
                        `helper.customProps.foreground.${colorScheme}`
                    );
                        ...
                        _.flatten(
                            _.map(
                                ...
                                (name) => [
                                    [
                                        name,
                                        `rgba(var(--helper-${name}-rgb), <alpha-value>)`,
                                    ],
                                    [
                                        `on-${name}`,
                                        `rgba(var(--helper-on-${name}-rgb), <alpha-value>)`,
                                    ],
                                ]
                            )
                        )
                    ...
                    customProps: {
                        background: {
                            light: {
                                ...
                                'bg-dialog': '#FFFFFF',
                                'bg-hover': chroma(colors.zinc[500])
                                    .alpha(0.08)
                                    .css(),
                                'bg-status-bar': colors.zinc[200],
                            },
                            dark: {
                                'bg-app-bar': colors.zinc[950],
                                'bg-card': colors.zinc[900],
                                'bg-default': colors.zinc[950],
                                'bg-dialog': colors.zinc[900],
                                'bg-hover': 'rgba(255, 255, 255, 0.05)',
                                'bg-status-bar': colors.zinc[950],
                            },
                        },
                        foreground: {
                            light: {
